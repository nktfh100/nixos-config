...

{
  ...
  home-manager.users.nktfh100.home.file.".config/opencode/tui.json".source = ./tui.json;
  home-manager.users.nktfh100.home.file.".config/opencode/AGENTS.md".source = ../../claude/CLAUDE.md;
